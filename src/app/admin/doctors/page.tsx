          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[#008de3] text-white">
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center w-[3rem]">#</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-left">Tipo</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-left">Provincia</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-left">Doctor</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center"># Especialización</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center"># Colegiado</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center"># Telefono</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-left">Correo</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center w-[5rem]">Firma</th>
                <th className="border border-slate-300 p-3 text-[0.7rem] font-black uppercase tracking-widest text-center w-[8rem]">Acciones</th>
              </tr>
            </thead>
            <tbody className="text-[#334155] text-[0.8rem] font-bold">
              {doctors.map((doc: any, index: number) => (
                <tr key={doc.id} className="hover:bg-blue-50/50 transition-colors">
                  <td className="border border-slate-300 p-3 text-center text-gray-400 font-normal">{index + 1}</td>
                  <td className="border border-slate-300 p-3">{doc.type || 'DR. CLIENTE'}</td>
                  <td className="border border-slate-300 p-3">{doc.province || ''}</td>
                  <td className="border border-slate-300 p-3 uppercase">{doc.name}</td>
                  <td className="border border-slate-300 p-3 text-center">{doc.specialization || ''}</td>
                  <td className="border border-slate-300 p-3 text-center">{doc.licenseNumber || ''}</td>
                  <td className="border border-slate-300 p-3 text-center">{doc.phone || '0'}</td>
                  <td className="border border-slate-300 p-3 lowercase">{doc.email || ''}</td>
              ...
              {(loading || doctors.length === 0) && !apiError && (
                <tr>
                  <td colSpan={10} className="p-20 text-center text-gray-300 font-black uppercase tracking-[0.4em] italic bg-gray-50/20 border border-slate-300">
