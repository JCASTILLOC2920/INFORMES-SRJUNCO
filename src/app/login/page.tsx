...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (username === 'jcastilloc' && password === 'JCPATH2026') {
    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-[1.5rem] relative overflow-hidden">
      ...
      <div className="max-w-[28rem] w-full bg-white/70 backdrop-blur-2xl rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.05)] p-[3rem] border border-white/50 animate-fade-in relative z-10">
        <div className="text-center mb-[2.5rem]">
          ...
          <h1 className="text-[1.75rem] font-black text-[#003d63] tracking-tighter italic">Acceso a Registro de Pacientes</h1>
          <p className="text-gray-400 text-[0.7rem] font-black uppercase tracking-[0.2em] mt-[0.5rem]">Sistema de Seguridad Paramilitar</p>
        </div>
          ...
          <div className="space-y-[0.5rem] relative">
            ...
            <div className="relative group">
              ...
              <button
                ...
                className={`absolute right-[0.75rem] top-1/2 -translate-y-1/2 p-[0.6rem] rounded-xl transition-all ${showPassword ? 'bg-[#008de3]/10 text-[#008de3]' : 'text-gray-400 hover:text-[#008de3] hover:bg-gray-100'}`}
              >
                {showPassword ? (
